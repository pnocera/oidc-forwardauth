...
type GenericOAuth struct {
	...
	Scopes       []string `long:"scope" env:"SCOPE" env-delim:"," default:"profile" description:"Scopes"`
	TokenStyle   string   `long:"token-style" env:"TOKEN_STYLE" default:"header" description:"How token is presented when querying the User URL"`
